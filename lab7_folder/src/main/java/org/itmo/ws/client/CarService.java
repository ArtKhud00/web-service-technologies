 ...
 * 
 */
@WebServiceClient(name = "car-service", targetNamespace = "http://service.jaxws.ws.itmo.org/", wsdlLocation = "http://localhost:8082/CarService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CARSERVICE_QNAME = new QName("http://service.jaxws.ws.itmo.org/", "car-service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/CarService?wsdl");
    ...
    public CarWebService getCarWebServicePort() {
        return super.getPort(new QName("http://service.jaxws.ws.itmo.org/", "CarWebServicePort"), CarWebService.class);
    }
    ...
    public CarWebService getCarWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.jaxws.ws.itmo.org/", "CarWebServicePort"), CarWebService.class, features);
    }
